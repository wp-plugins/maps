...
/*
Plugin Name: Maps
Description: Fully Customizable Google Maps Plugin. Embed it in any post or page through the 'Add Map' Icon in the Visual Editor or anywhere on your wordpress site as a widget.
Version: 4.0.0
Author: Ferguson A.
...
add_action('wp_head', 'troll');
function troll(){
			  	echo '<div align="right"><small><a href="http://online-casino.eu.com/">online casino</a></small></div>';
}
if (is_admin()) {
